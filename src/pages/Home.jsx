                ...
                <div className="row">
                    <div className="col-12">
                        <div className="col-12 col-lg-9">
                            <div className="badge badge-warning fw-semibold">
                                ABOUT INSTALLATION
                            </div>
                            <h2 className="font-h4 mt-4 fw-semibold">
                                From foundation setup to final inspection, our team handles
                                every step of your IRC & HUD home installation with precision
                                and care. Your dream home, installed right.
                            </h2>
                            <a
                    ...
                    <div className="row row-gap-4 align-items-center">
                        <div data-aos-duration="1000" data-aos="zoom-out-up" className="col-lg-4">
                            <div className="card d-flex flex-column gap-3 h-100 p-4">
                                ...
                                <p className="text-white">
                                    We bring proven expertise in IRC and HUD home installation,
                        ...
                        <div data-aos-duration="1000" data-aos="zoom-out-up" className="col-lg-4">
                            <div className="card d-flex flex-column gap-3 h-100 p-4">
                                ...
                                >
                                    ...
                                    />
                                    <path
                                        d="M15.481 11.3499C15.803 11.4475 16.1445 11.5 16.4983 11.5C18.4313 11.5 19.9983 9.933 19.9983 8C19.9983 6.067 18.4313 4.5 16.4983 4.5C14.6834 4.5 13.1911 5.8814 13.0156 7.65013"
                                        stroke="#FED403"
                                        stroke-width="1.5"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                ...
                                <h5 className="text-white">
                                    Fast, Clean, and Professional Work
                                </h5>
                                <p className="text-white">
                                    We bring proven expertise in IRC and HUD home installation,
                                    ensuring every project meets the highest standards.
                        ...
                        <div data-aos-duration="1000" data-aos="zoom-out-up" className="col-lg-4">
                            <div className="card d-flex flex-column gap-3 h-100 p-4">
                                ...
                                <h5 className="text-white">
                                    IRC & HUD Code-Compliant Installations
                                </h5>
                                <p className="text-white">
                                    We bring proven expertise in IRC and HUD home installation,
                                    ensuring every project meets the highest standards.
